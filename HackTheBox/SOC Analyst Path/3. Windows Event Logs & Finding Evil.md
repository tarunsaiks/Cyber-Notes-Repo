...
But if you see **random system processes like `spoolsv.exe` (the print spooler)** loading those DLLs, that’s a **red flag** — it means someone might be injecting C# code into it!

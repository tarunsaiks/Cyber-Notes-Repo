...
- **Common Techniques:**  
  ...
  - ==**Phishing for information (T1598.003)**== -  send phishing messages to elicit sensitive information that can be used during targeting
...
- **Common Techniques:**  
  ...
  - ==**Search Victim-Owned Websites (T1596.002)**== – Reconnaissance for publicly available data.  
...
- **Differences**:  
  - **APT29** is **espionage-focused** and targets **governments**.  
